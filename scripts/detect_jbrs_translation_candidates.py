...
def main() -> None:
    ...
    rows = build_translation_candidate_rows(reference_rows, manifest_rows, match_rows, status_rows)
    write_tsv(args.output, rows, TRANSLATION_CANDIDATE_FIELDS)
    summary = build_pilot_summary(reference_rows, manifest_rows, match_rows, batch_rows, status_rows, rows)
