...
def build_translation_source_action_rows(
    ...
    action_specs = [
        ...
        },
        {
            ...
            "action_status": "linkage_unresolved_needs_human_review",
            "next_action": "Obtain a direct structured-corpus crosswalk for P1/B1/P2/B2/A before promotion.",
            "evidence": "OCR confirms a standalone translation section, but searches for the article's unique donor/date text and Ananda brick-monastery phrasing did not produce a structured corpus record match.",
            "notes": "Translation is present locally, but no high-confidence corpus link can be made from current local evidence.",
        },
        {
